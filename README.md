...
preserved in its original form and provided in **Italian and English**.
This layer is explicitly separated from any experimental, computational,
or interpretative work.

---

## Purpose

The purpose of this repository is **not** to explain, validate, simplify,
or operationalize the ideas contained in the texts.
...
The Italian and English versions are considered **equivalent canonical representations**
of the same phenomenological layer.
...
**must live in separate repositories** and must reference this one
